...
const ProductDetail: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-6 py-12 md:py-24 bg-brand-light dark:bg-brand-dark transition-colors duration-500 min-h-screen">
      <button 
        onClick={() => navigate('/')} 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
        ...
        <div className="lg:col-span-7 relative">
          ...
          <p className="text-center text-[9px] font-black uppercase tracking-widest opacity-20 mt-4 md:hidden">Натисніть на фото для перегляду</p>
        </div>
        ...
        <div className="lg:col-span-5 flex flex-col pt-4 lg:pt-10">
          <div className="mb-12">
            ...
            <h1 className="text-5xl md:text-7xl font-black font-display uppercase mb-6 leading-[0.9] tracking-tighter">
              {product.name}
            </h1>
          ...
          <div className="space-y-12 mb-16">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg font-light leading-relaxed opacity-70 border-l-2 border-black/5 dark:border-white/5 pl-8 py-2 whitespace-pre-line">
                {product.description}
              </p>
            </div>
          </div>
      ...
      {fullsizeImage && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 md:p-12 animate-in fade-in duration-300">
          ...
          {/* Navigation Buttons */}
          {product.images.length > 1 && (
            <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 flex justify-between px-4 md:px-12 z-[220] pointer-events-none">
              <button 
                onClick={prevFullImg}
                className="p-4 md:p-6 bg-white/10 backdrop-blur-xl border border-white/20 text-white rounded-full pointer-events-auto hover:bg-white hover:text-black transition-all active:scale-90"
              >
                <ChevronLeft size={32} />
              </button>
              <button 
          ...
          {/* Image Counter */}
          <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-[220] bg-white/10 backdrop-blur-md px-6 py-2 rounded-full border border-white/10">
