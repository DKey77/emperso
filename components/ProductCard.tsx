...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  return (
    <div className="group flex flex-col space-y-4 bg-white dark:bg-white/5 p-2 rounded-xl transition-all duration-500 hover:shadow-2xl hover:shadow-black/5 dark:hover:shadow-none">
      ...
      <div className="flex justify-between items-start px-2 pb-2">
        <div>
          <h3 className="text-sm font-bold uppercase tracking-wider group-hover:underline transition-all">
